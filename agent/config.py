"""
Smart Transit & Commuter Agent — theme definitions and persistent configuration.

Config is stored at ~/.smart_transit_agent/config.json and is loaded at startup.
...
CONFIG_DIR   = Path.home() / ".smart_transit_agent"
